...
export default function App() {
  ...
  const schemaLD = {
    ...
    "@type": "BeautySalon",
    name: "Sonal Signature Makeups",
    url: "https://www.sonalsignaturemakeups.shop",
    logo: "https://www.sonalsignaturemakeups.shop/logo.png",
    image: "https://www.sonalsignaturemakeups.shop/About.jpeg",
    description:
      "Professional bridal makeup artist in Jaipur offering luxury bridal makeup, HD makeup, airbrush makeup, engagement makeup, party makeup, and wedding hairstyling.",
    areaServed: {
      "@type": "City",
      name: "Jaipur",
    },
    ...
    telephone: "+91-7568616646",
    priceRange: "₹₹₹",
    openingHours: "Mo-Su 09:00-20:00",
    sameAs: [
      "https://www.instagram.com/sonalmakeovers/",
    ],
    hasOfferCatalog: {
      "@type": "OfferCatalog",
      name: "Makeup & Hairstyling Services",
      itemListElement: [
        { "@type": "Offer", itemOffered: { "@type": "Service", name: "Bridal Makeup Jaipur" } },
        { "@type": "Offer", itemOffered: { "@type": "Service", name: "Airbrush Makeup Jaipur" } },
        { "@type": "Offer", itemOffered: { "@type": "Service", name: "HD Makeup Jaipur" } },
        { "@type": "Offer", itemOffered: { "@type": "Service", name: "Engagement Makeup Jaipur" } },
        { "@type": "Offer", itemOffered: { "@type": "Service", name: "Pre-Wedding Shoot Makeup Jaipur" } },
        { "@type": "Offer", itemOffered: { "@type": "Service", name: "Party Makeup Jaipur" } },
        { "@type": "Offer", itemOffered: { "@type": "Service", name: "Editorial Makeup Jaipur" } },
        { "@type": "Offer", itemOffered: { "@type": "Service", name: "Bridal Hairstyling Jaipur" } },
      ],
    },
    aggregateRating: {
  ...
  return (
    <>
      <Helmet>
        <title>Best Bridal Makeup Artist in Jaipur | Sonal Signature Makeups</title>

        <meta
          name="description"
          content="Sonal Signature Makeups — top-rated bridal makeup artist in Jaipur offering luxury bridal makeup, HD makeup, airbrush makeup, engagement, pre-wedding & party makeup by Sonal Saini."
        />

        <meta
          name="keywords"
          content="bridal makeup artist Jaipur, best bridal makeup artist Jaipur, wedding makeup artist Jaipur, HD makeup artist Jaipur, airbrush makeup Jaipur, engagement makeup Jaipur, party makeup artist Jaipur, pre-wedding makeup Jaipur, Sonal Saini makeup artist, makeup artist near me Jaipur"
        />

        <meta name="robots" content="index, follow" />
        <meta name="author" content="Sonal Saini" />

        <link rel="canonical" href="https://www.sonalsignaturemakeups.shop/" />

        {/* LLM discovery links */}
        <link rel="llms" href="https://www.sonalsignaturemakeups.shop/llms.txt" type="text/plain" />
        <link rel="alternate" href="https://www.sonalsignaturemakeups.shop/llms-full.md" type="text/markdown" title="AI-readable site content" />

        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content="Best Bridal Makeup Artist in Jaipur | Sonal Signature Makeups"
        />
        <meta
          property="og:description"
          content="Luxury bridal makeup artist in Jaipur specialising in bridal makeup, HD makeup, airbrush makeup, and wedding hairstyling — by Sonal Saini."
        />
        <meta property="og:url" content="https://www.sonalsignaturemakeups.shop/" />
        <meta property="og:image" content="https://www.sonalsignaturemakeups.shop/About.jpeg" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:locale" content="en_IN" />
        <meta property="og:site_name" content="Sonal Signature Makeups" />

        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Best Bridal Makeup Artist in Jaipur | Sonal Signature Makeups" />
        <meta name="twitter:description" content="Luxury bridal makeup & hairstyling by Sonal Saini, Jaipur. HD, airbrush, bridal, pre-wedding & party makeup." />
        <meta name="twitter:image" content="https://www.sonalsignaturemakeups.shop/About.jpeg" />
      ...
      <div style={{ minHeight: "100vh", background: "var(--cream)" }}>
          ...
          >
            {heroIn && (
              <>
                ...
                <div className="fade-up d4 hero-btn-group">
                  <a
                    href={WHATSAPP_URL}
                    target="_blank"
          ...
          <div style={{ maxWidth: 1200, margin: "0 auto" }}>
            ...
            <div className="portfolio-grid">
              {GALLERY.map((g, i) => (
                <div
                  key={i}
                  className={`gallery-item ${i === 0 || i === 3 ? "featured" : ""}`}
                >
                  <img
                    src={g.src}
                    alt={`${g.label} by Sonal Saini, bridal makeup artist Jaipur`}
                    loading="lazy"
                    width="400"
                    height="500"
                  />
        ...
        <section id="about" className="section-pad" style={{ background: "white", padding: "100px 28px" }}>
          ...
          >
            ...
            <div>
              ...
              >
                With over 8 years of expertise in luxury bridal makeup and hairstyling, I have
            ...
            <div style={{ position: "relative" }}>
              ...
              >
                <img
                  src="/About.jpeg"
                  alt="Sonal Saini — bridal makeup artist Jaipur"
              ...
              <div
                ...
                style={{
                  position: "absolute",
                  background: "#7a3a4a", borderRadius: 18,
        ...
        <section
          ...
          style={{ background: "var(--cream)", padding: "80px 28px" }}
        >
        ...
        {/* ── Footer ── */}
        <footer style={{ background: "#2a0e18", padding: "36px 28px", textAlign: "center" }}>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Sonal Signature Makeups on Instagram"
            style={{
              display: "inline-flex", alignItems: "center", justifyContent: "center",
              width: 46, height: 46, borderRadius: "50%",
              background: "rgba(255,255,255,0.08)", color: "#f9ecec", textDecoration: "none",
              marginBottom: 16,
            }}
          >
            <FaInstagram size={20} />
          ...
          <p
            style={{
              color: "#d6a0aa", fontSize: 12, letterSpacing: "0.2em",
              textTransform: "uppercase", marginBottom: 8,
              fontFamily: "'DM Sans', sans-serif",
            }}
          >
            © 2026 Sonal Signature Makeups · Jaipur, Rajasthan · All rights reserved
          </p>
        </footer>
      </div>
    </>
